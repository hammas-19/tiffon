    ...
    <div class="bg-linen">
        ...
        <section class="max-w-7xl mx-auto md:px-6 px-3 md:py-10 py-5">
            ...
            <div
                ...
                <img src="https://blogger.googleusercontent.com/img/a/AVvXsEgoiDLwMPT4ev1sKXWoYL-Jbc_b75DLDRixMRfVdL7l4aQOQKl2aSCtkYL5X1t0tsPWpV94UN4qDZOTt-vmLyw9dKiw7GQOJTNc4z_PXN5gjSfBmcTjqQhMmpxtcSPuEXAA8Nw-4V8lNhKqIgjBgGRauq8mrIIPPBeRXZb4nsKKdLst8TPOsnyEgsr1"
                ...
                <div
                    ...
                    <NuxtLink
                        class="text-graphite py-2 px-4 w-fit hover:w-auto opacity-10 hover:opacity-100 transition-all duration-500 text-left hover:text-center rounded-md bg-white text-xl font-semibold">
                        Shop Men
                    </NuxtLink>
                    <NuxtLink
                        class="text-graphite py-2 px-4 w-fit hover:w-auto opacity-10 hover:opacity-100 transition-all duration-500 text-left hover:text-center rounded-md bg-white text-xl font-semibold">

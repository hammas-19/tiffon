                ...
                <div class="grid grid-cols-1 items-start gap-8 md:grid-cols-3">
                        ...
                        <div class=" mt-8 flex justify-between">
                            <div class="max-w-[35ch] space-y-2">
                                ...
                                <div class="-ms-0.5 flex">
                                    <svg class="h-5 w-5 text-tango" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path
                    ...
                    <div
                        ...
                        <span class="flex justify-center items-center w-full md:sticky absolute top-1">
                            <strong
                                class="rounded-full bg-gray-100 w-fit px-3 py-0.5 text-xs font-medium tracking-wide text-tango">
                                <span class="hidden md:block">Swipe Down</span>
                                <span class="block md:hidden">Swipe left</span>
                            </strong>
                        </span>

                        <img v-for=" items in 7" alt="Les Paul"
                            src="https://cdn.shopify.com/s/files/1/1752/8007/products/ClassicZipHoodieAutumn3_400x.jpg?v=1675726245"
